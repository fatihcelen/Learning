    ...
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            for (int i = 1; i < 21; i++)
            {
                ...
                driver.Navigate().GoToUrl("https://www.sahibinden.com/satilik-daire/ankara-mamak-mamak-altiagac-mh.?pagingOffset=" + ((i - 1) * 50) + "&pagingSize=50&sorting=date_desc");
